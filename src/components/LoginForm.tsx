    ...
    return(
        <section className="relative z-50">
            <form className="w-[250px] h-[300px] mx-auto mt-10  grid place-content-center rounded-sm">
                ...
                <button type="submit" className="block w-[170px] h-[40px] font-semibold border-primaryText border-dashed border-2 relative z-50 mt-10 hover:font-bold hover:text-primaryText/80">Login</button>
            </form>
        </section>
    )
}